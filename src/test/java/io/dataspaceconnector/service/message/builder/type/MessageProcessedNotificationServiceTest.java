...
@SpringBootTest(classes = {MessageProcessedNotificationService.class})
class MessageProcessedNotificationServiceTest {
    ...
    public void buildMessage_validDesc_returnValidMessage() {
        ...
        /* ACT */
        final var result = (MessageProcessedNotificationMessage) notificationService.buildMessage(desc);
