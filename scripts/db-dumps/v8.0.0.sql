...
CREATE TABLE public.authentication (
    ...
    api_value character varying(2048),
...
--
-- Name: authentication_id_seq; Type: SEQUENCE; Schema: public; Owner: connector
--
...
ALTER TABLE public.authentication_id_seq OWNER TO connector;

--
-- Name: authentication_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: connector
--
...
--
-- Name: daps; Type: TABLE; Schema: public; Owner: connector
--

CREATE TABLE public.daps (
    id uuid NOT NULL,
    bootstrap_id character varying(2048),
    created_date timestamp without time zone NOT NULL,
    deleted boolean,
...
ALTER TABLE public.daps OWNER TO connector;

--
-- Name: daps_additional; Type: TABLE; Schema: public; Owner: connector
--

CREATE TABLE public.daps_additional (
    daps_id uuid NOT NULL,
    additional character varying(255),
    additional_key character varying(255) NOT NULL
);


ALTER TABLE public.daps_additional OWNER TO connector;
...
--
-- Name: data_id_seq; Type: SEQUENCE; Schema: public; Owner: connector
--
...
ALTER TABLE public.data_id_seq OWNER TO connector;

--
-- Name: data_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: connector
--
...
--
-- Name: authentication id; Type: DEFAULT; Schema: public; Owner: connector
--
...
--
-- Name: data id; Type: DEFAULT; Schema: public; Owner: connector
--
...
--
-- Name: 17126; Type: BLOB; Schema: -; Owner: connector
--

SELECT pg_catalog.lo_create('17126');


ALTER LARGE OBJECT 17126 OWNER TO connector;

--
-- Data for Name: agreement; Type: TABLE DATA; Schema: public; Owner: connector
--

COPY public.agreement (id, bootstrap_id, created_date, deleted, modified_date, archived, confirmed, remote_id, agreement_value) FROM stdin;
\.
...
COPY public.authentication (dtype, id, deleted, api_key, api_value, password, username) FROM stdin;
\.
...
COPY public.configuration (id, bootstrap_id, created_date, deleted, modified_date, description, title, active, connector_id, curator, default_endpoint, deploy_mode, log_level, maintainer, outbound_model_version, public_key, security_profile, status, version, keystore_id, proxy_id, truststore_id) FROM stdin;
d58a09c8-653d-4bc7-a4ac-8a9ebbe942a0	\N	2022-08-18 09:20:38.585049	f	2022-08-18 09:20:38.585065	IDS Connector reference implementation	Dataspace Connector	t	https://w3id.org/idsa/autogen/baseConnector/7b934432-a85e-41c5-9f65-669219dde4ea	https://example.org/	https://localhost:8080/api/ids/data	TEST	WARN	https://sovity.de/	4.2.7	17126	BASE_SECURITY	ONLINE	8.0.0	0aba7e71-565d-47d4-b6a2-9bbab548ab85	\N	a5b8b2cc-db7c-49bc-91ff-fd66a0909d2a
\.
...
d58a09c8-653d-4bc7-a4ac-8a9ebbe942a0	4.2.6
d58a09c8-653d-4bc7-a4ac-8a9ebbe942a0	4.2.7
d58a09c8-653d-4bc7-a4ac-8a9ebbe942a0	4.2.0
d58a09c8-653d-4bc7-a4ac-8a9ebbe942a0	4.2.1
d58a09c8-653d-4bc7-a4ac-8a9ebbe942a0	4.1.2
d58a09c8-653d-4bc7-a4ac-8a9ebbe942a0	4.0.0
d58a09c8-653d-4bc7-a4ac-8a9ebbe942a0	4.1.0
d58a09c8-653d-4bc7-a4ac-8a9ebbe942a0	4.2.4
d58a09c8-653d-4bc7-a4ac-8a9ebbe942a0	4.2.5
d58a09c8-653d-4bc7-a4ac-8a9ebbe942a0	4.2.2
d58a09c8-653d-4bc7-a4ac-8a9ebbe942a0	4.2.3
\.
...
COPY public.contractrule (id, bootstrap_id, created_date, deleted, modified_date, description, title, remote_id, contractrule_value) FROM stdin;
\.
...
--
-- Data for Name: daps_additional; Type: TABLE DATA; Schema: public; Owner: connector
--

COPY public.daps_additional (daps_id, additional, additional_key) FROM stdin;
\.
...
COPY public.data (dtype, id, deleted, localdata_value, access_url) FROM stdin;
\.
...
COPY public.datasource (dtype, id, bootstrap_id, created_date, deleted, modified_date, driver_class_name, url, authentication_id) FROM stdin;
\.
...
COPY public.endpoint (dtype, id, bootstrap_id, created_date, deleted, modified_date, docs, info, location, type, endpoint_port, endpoint_type, language, media_type, path, protocol, exposed_port, data_source_id) FROM stdin;
\.
...
0aba7e71-565d-47d4-b6a2-9bbab548ab85	\N	2022-08-18 09:20:38.576261	f	2022-08-18 09:20:38.576293	1	file:///conf/keystore-localhost.p12	password
\.
...
COPY public.route (id, bootstrap_id, created_date, deleted, modified_date, description, title, configuration, deploy, end_id, output_id, start_id) FROM stdin;
\.
...
a5b8b2cc-db7c-49bc-91ff-fd66a0909d2a	\N	2022-08-18 09:20:38.584195	f	2022-08-18 09:20:38.584224	1	file:///conf/truststore.p12	password
\.
...
--
-- Name: authentication_id_seq; Type: SEQUENCE SET; Schema: public; Owner: connector
--
...
--
-- Name: data_id_seq; Type: SEQUENCE SET; Schema: public; Owner: connector
--
...
SELECT pg_catalog.lowrite(0, '\x4d');
...
--
-- Name: daps_additional daps_additional_pkey; Type: CONSTRAINT; Schema: public; Owner: connector
--

ALTER TABLE ONLY public.daps_additional
    ADD CONSTRAINT daps_additional_pkey PRIMARY KEY (daps_id, additional_key);


--
-- Name: daps daps_pkey; Type: CONSTRAINT; Schema: public; Owner: connector
--
...
--
-- Name: daps_additional fkodv5dvsh1ngg5kcx07ccetinr; Type: FK CONSTRAINT; Schema: public; Owner: connector
--

ALTER TABLE ONLY public.daps_additional
    ADD CONSTRAINT fkodv5dvsh1ngg5kcx07ccetinr FOREIGN KEY (daps_id) REFERENCES public.daps(id);


--
-- Name: route fkp1ks1pqybwte5899wtu1vav55; Type: FK CONSTRAINT; Schema: public; Owner: connector
--
